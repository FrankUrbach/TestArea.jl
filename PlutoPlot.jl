...
# ╔═╡ aff68768-262d-11ec-3a6c-db6893f9750d
using WGLMakie, AbstractPlotting, JSServe, Colors

# ╔═╡ 60ac9007-6a5f-4372-b4c6-64eb5df6c03c
using JSServe.DOM

# ╔═╡ de8f6a23-7323-4997-bfdb-4708350a8cea
Page(exportable=true, offline=true)

# ╔═╡ 947a1d60-08fa-4753-a8da-09b1c2974e6a
begin
	# Set the default resolution to something that fits the Documenter theme
	WGLMakie.set_theme!(resolution=(800, 400))
	WGLMakie.scatter(1:200, color=1:200)
end

# ╔═╡ b1ebdf15-b871-49d9-af4e-b2c8e670aa83
begin
	N = 60
